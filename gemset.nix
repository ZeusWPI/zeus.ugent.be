{
  ...
  guard = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0rhnjyb0g2jmy7d8rkf10802f401ii37g2gf10y0vnz3ml0zsh7p";
      type = "gem";
    };
    version = "2.19.0";
  };
  ...
  nanoc = {
    dependencies = ["addressable" "nanoc-checking" "nanoc-cli" "nanoc-core" "nanoc-deploying" "parallel" "tty-command" "tty-which"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  nanoc-cli = {
    dependencies = ["cri" "diff-lcs" "logger" "nanoc-core" "pry" "zeitwerk"];
    groups = ["default" "development" "nanoc"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  nanoc-core = {
    dependencies = ["base64" "concurrent-ruby" "ddmetrics" "ddplugin" "immutable-ruby" "json_schema" "memo_wise" "slow_enumerator_tools" "tty-platform" "zeitwerk"];
    groups = ["default" "development" "nanoc"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  pandoc-ruby = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1ckl5g8jkfdnvxlwy7vzbj98ryxvxvk31ciwbfr7yrbibrmksr9p";
      type = "gem";
    };
    version = "2.1.10";
  };
  ...
  pstore = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1i5k5a65ppn2p2w55bmq5mn5kml5jz4s24617sn7g4ipk79agdh4";
      type = "gem";
    };
    version = "0.1.3";
  };
