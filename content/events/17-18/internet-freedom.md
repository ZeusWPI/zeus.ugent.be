...
This event is part of the [TeCH TalkZ](<%= localized_path(@items['/blog/17-18/tech-talkz.md'].path) %>), a collaboration between the two student associations Zeus WPI and CenEka.
