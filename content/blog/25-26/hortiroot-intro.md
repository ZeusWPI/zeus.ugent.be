...
Enkele weken geleden werden we gecontacteerd door de vakgroep [HortiRoot](https://www.ugent.be/bw/plants-and-crops/en/research/hortiroot).
...
Voor de software echter, merkten ze dat de UGent geen equivalent van die workshop heeft.
De onderzoekers van HortiRoot hebben zelf wat geprobeerd om de standaard Windows 10 Epson software te automatiseren met behulp van `pyautogui`, wat natuurlijk niet goed schaalt...
Ze hadden ook de software voor *Ubuntu* uitgeprobeerd, maar die advonturen waren jammergenoeg van korte duur omdat DICT geen ondersteundend personeel had met voldoende expertise hiermee.
...
Met wat instrumentatie aan `esponscan2` toe voegen en veel verschillende opstellingen te proberen, vonden we uiteindelijk een oplossing.
...
De geproduceerde afbeeldingen worden dan van de node naar de machine waar de webapp draait verplaatst.
