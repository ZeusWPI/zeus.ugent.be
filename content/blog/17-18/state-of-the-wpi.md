...
- De [verslagen](<%= localized_path(@items['/about/verslagen.erb'].path) %>)-pagina is een ding, net zoals een pagina met de Zeus-[historiek](<%= localized_path(@items['/about/historiek.erb'].path) %>)
